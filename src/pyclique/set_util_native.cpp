...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "language": "c++",
        "name": "pyclique.set_util_native",
        "sources": [
            "src/pyclique/set_util_native.pyx"
        ]
    },
    "module_name": "pyclique.set_util_native"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pyclique__set_util_native
#define __PYX_HAVE_API__pyclique__set_util_native
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
/* Module declarations from 'pyclique.set_util_native' */
...
static PyObject *__pyx_f_8pyclique_15set_util_native__intersect_sorted_cython(__Pyx_memviewslice, __Pyx_memviewslice, std::vector<int>  &); /*proto*/
static PyObject *__pyx_f_8pyclique_15set_util_native_intersect_sorted_cython(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "pyclique.set_util_native"
extern int __pyx_module_is_main_pyclique__set_util_native;
int __pyx_module_is_main_pyclique__set_util_native = 0;

/* Implementation of 'pyclique.set_util_native' */
...
static PyObject *__pyx_pf_8pyclique_15set_util_native_intersect_sorted_cython(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_B); /* proto */
...
/* "pyclique/set_util_native.pyx":11
 * 
 * 
...
static PyObject *__pyx_f_8pyclique_15set_util_native__intersect_sorted_cython(__Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_B, std::vector<int>  &__pyx_v_C) {
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_intersect_sorted_cython", 0);

  /* "pyclique/set_util_native.pyx":12
 * 
 * cdef _intersect_sorted_cython(int[:] A, int[:] B, vector[int]& C):
 * 	cdef int i = 0             # <<<<<<<<<<<<<<
 * 	cdef int j = 0
 ...
 */
  ...
  /* "pyclique/set_util_native.pyx":13
 * cdef _intersect_sorted_cython(int[:] A, int[:] B, vector[int]& C):
 * 	cdef int i = 0
 * 	cdef int j = 0             # <<<<<<<<<<<<<<
 * 	while i < A.shape[0] and j < B.shape[0]:
 ...
 */
  ...
  /* "pyclique/set_util_native.pyx":14
 * 	cdef int i = 0
 * 	cdef int j = 0
 * 	while i < A.shape[0] and j < B.shape[0]:             # <<<<<<<<<<<<<<
 * 		if A[i] == B[j]:
 ...
 */
  while (1) {
    __pyx_t_2 = ((__pyx_v_i < (__pyx_v_A.shape[0])) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
      goto __pyx_L5_bool_binop_done;
    }
    __pyx_t_2 = ((__pyx_v_j < (__pyx_v_B.shape[0])) != 0);
    __pyx_t_1 = __pyx_t_2;
    __pyx_L5_bool_binop_done:;
    if (!__pyx_t_1) break;

    /* "pyclique/set_util_native.pyx":15
 * 	cdef int j = 0
 * 	while i < A.shape[0] and j < B.shape[0]:
 * 		if A[i] == B[j]:             # <<<<<<<<<<<<<<
 * 			C.push_back(A[i])
 ...
 */
    __pyx_t_3 = __pyx_v_i;
    __pyx_t_4 = __pyx_v_j;
    __pyx_t_1 = (((*((int *) ( /* dim=0 */ (__pyx_v_A.data + __pyx_t_3 * __pyx_v_A.strides[0]) ))) == (*((int *) ( /* dim=0 */ (__pyx_v_B.data + __pyx_t_4 * __pyx_v_B.strides[0]) )))) != 0);
    if (__pyx_t_1) {

      /* "pyclique/set_util_native.pyx":16
 * 	while i < A.shape[0] and j < B.shape[0]:
 * 		if A[i] == B[j]:
 * 			C.push_back(A[i])             # <<<<<<<<<<<<<<
 * 			i += 1
 ...
 */
      __pyx_t_4 = __pyx_v_i;
      try {
        __pyx_v_C.push_back((*((int *) ( /* dim=0 */ (__pyx_v_A.data + __pyx_t_4 * __pyx_v_A.strides[0]) ))));
      } catch(...) {
        __Pyx_CppExn2PyErr();
        __PYX_ERR(0, 16, __pyx_L1_error)
      }

      /* "pyclique/set_util_native.pyx":17
 * 		if A[i] == B[j]:
 * 			C.push_back(A[i])
 * 			i += 1             # <<<<<<<<<<<<<<
 * 			j += 1
 ...
 */
      ...
      /* "pyclique/set_util_native.pyx":18
 * 			C.push_back(A[i])
 * 			i += 1
 * 			j += 1             # <<<<<<<<<<<<<<
 * 		elif A[i] < B[j]:
 ...
 */
    ...
    /* "pyclique/set_util_native.pyx":19
 * 			i += 1
 * 			j += 1
 * 		elif A[i] < B[j]:             # <<<<<<<<<<<<<<
 * 			i += 1
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_t_3 = __pyx_v_j;
    __pyx_t_1 = (((*((int *) ( /* dim=0 */ (__pyx_v_A.data + __pyx_t_4 * __pyx_v_A.strides[0]) ))) < (*((int *) ( /* dim=0 */ (__pyx_v_B.data + __pyx_t_3 * __pyx_v_B.strides[0]) )))) != 0);
    if (__pyx_t_1) {

      /* "pyclique/set_util_native.pyx":20
 * 			j += 1
 * 		elif A[i] < B[j]:
 * 			i += 1             # <<<<<<<<<<<<<<
 * 		else:
 ...
 */
    ...
    /* "pyclique/set_util_native.pyx":22
 * 			i += 1
 * 		else:
 * 			j += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("pyclique.set_util_native._intersect_sorted_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "pyclique/set_util_native.pyx":24
 * 			j += 1
 * 
 * cpdef intersect_sorted_cython(int[:] A, int[:] B):             # <<<<<<<<<<<<<<
 * 	cdef vector[int] C
...
static PyObject *__pyx_pw_8pyclique_15set_util_native_1intersect_sorted_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_8pyclique_15set_util_native_intersect_sorted_cython(__Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_B, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("intersect_sorted_cython", 0);

  /* "pyclique/set_util_native.pyx":26
 * cpdef intersect_sorted_cython(int[:] A, int[:] B):
 * 	cdef vector[int] C
 * 	C.reserve(min(A.shape[0], B.shape[0]))             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_v_C.reserve(__pyx_t_3);

  /* "pyclique/set_util_native.pyx":27
 * 	cdef vector[int] C
 * 	C.reserve(min(A.shape[0], B.shape[0]))
 * 	_intersect_sorted_cython(A, B, C)             # <<<<<<<<<<<<<<
 * 	return(C)
 */
  __pyx_t_4 = __pyx_f_8pyclique_15set_util_native__intersect_sorted_cython(__pyx_v_A, __pyx_v_B, __pyx_v_C); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

  /* "pyclique/set_util_native.pyx":28
 * 	C.reserve(min(A.shape[0], B.shape[0]))
 * 	_intersect_sorted_cython(A, B, C)
 * 	return(C)             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_4 = __pyx_convert_vector_to_py_int(__pyx_v_C); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_r = __pyx_t_4;
  __pyx_t_4 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("pyclique.set_util_native.intersect_sorted_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_8pyclique_15set_util_native_1intersect_sorted_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8pyclique_15set_util_native_1intersect_sorted_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("intersect_sorted_cython (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_B)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("intersect_sorted_cython", 1, 2, 2, 1); __PYX_ERR(0, 24, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "intersect_sorted_cython") < 0)) __PYX_ERR(0, 24, __pyx_L3_error)
      }
    ...
    __pyx_v_A = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_A.memview)) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_B = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_B.memview)) __PYX_ERR(0, 24, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("intersect_sorted_cython", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 24, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyclique.set_util_native.intersect_sorted_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8pyclique_15set_util_native_intersect_sorted_cython(__pyx_self, __pyx_v_A, __pyx_v_B);
...
static PyObject *__pyx_pf_8pyclique_15set_util_native_intersect_sorted_cython(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_B) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("intersect_sorted_cython", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_8pyclique_15set_util_native_intersect_sorted_cython(__pyx_v_A, __pyx_v_B, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 24, __pyx_L1_error)
 ...
 *         if itemsize <= 0:
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(2, 134, __pyx_L1_error)
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(2, 137, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 * 
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_MemoryError, __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(2, 149, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
      __pyx_t_10 = __Pyx_PyObject_Call(__pyx_builtin_MemoryError, __pyx_tuple__4, NULL); if (unlikely(!__pyx_t_10)) __PYX_ERR(2, 177, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_Raise(__pyx_t_10, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
 ...
 *         info.len = self.len
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__5, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(2, 193, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_TypeError, __pyx_tuple__8, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(2, 420, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
 ...
 *             if len(self.view.format) == 1:
 */
      __pyx_t_6 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__9, NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(2, 497, __pyx_L5_except_error)
      __Pyx_GOTREF(__pyx_t_6);
 ...
 *         if flags & PyBUF_ND:
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__10, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(2, 522, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__11, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(2, 572, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_Raise(__pyx_t_2, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = PyNumber_Multiply(__pyx_tuple__12, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(2, 579, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_r = __pyx_t_3;
    __pyx_t_3 = 0;
 ...
 */
      /*else*/ {
        __pyx_t_9 = __Pyx_PyList_Append(__pyx_v_result, __pyx_slice__15); if (unlikely(__pyx_t_9 == ((int)-1))) __PYX_ERR(2, 687, __pyx_L1_error)
      }
      __pyx_L7:;
 ...
 * 
 */
      __pyx_t_5 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__16, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(2, 705, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pyclique.set_util_native.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyclique.set_util_native.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyclique.set_util_native.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyclique.set_util_native._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"intersect_sorted_cython", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_8pyclique_15set_util_native_1intersect_sorted_cython, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_set_util_native(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_set_util_native},
  {0, NULL}
};
#endif
 ...
 *         if itemsize <= 0:
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Empty_shape_tuple_for_cython_arr); if (unlikely(!__pyx_tuple_)) __PYX_ERR(2, 134, __pyx_L1_error)
 ...
 *         if not isinstance(format, bytes):
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_itemsize_0_for_cython_array); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(2, 137, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_kp_s_unable_to_allocate_shape_and_str); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(2, 149, __pyx_L1_error)
 ...
 *             if self.dtype_is_object:
 */
  __pyx_tuple__4 = PyTuple_Pack(1, __pyx_kp_s_unable_to_allocate_array_data); if (unlikely(!__pyx_tuple__4)) __PYX_ERR(2, 177, __pyx_L1_error)
 ...
 *         info.len = self.len
 */
  __pyx_tuple__5 = PyTuple_Pack(1, __pyx_kp_s_Can_only_create_a_buffer_that_is); if (unlikely(!__pyx_tuple__5)) __PYX_ERR(2, 193, __pyx_L1_error)
 ...
 *         have_slices, index = _unellipsify(index, self.view.ndim)
 */
  __pyx_tuple__8 = PyTuple_Pack(1, __pyx_kp_s_Cannot_assign_to_read_only_memor); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(2, 420, __pyx_L1_error)
 ...
 *             if len(self.view.format) == 1:
 */
  __pyx_tuple__9 = PyTuple_Pack(1, __pyx_kp_s_Unable_to_convert_item_to_object); if (unlikely(!__pyx_tuple__9)) __PYX_ERR(2, 497, __pyx_L1_error)
 ...
 *         if flags & PyBUF_ND:
 */
  __pyx_tuple__10 = PyTuple_Pack(1, __pyx_kp_s_Cannot_create_writable_memory_vi); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(2, 522, __pyx_L1_error)
 ...
 *         return tuple([stride for stride in self.view.strides[:self.view.ndim]])
 */
  __pyx_tuple__11 = PyTuple_Pack(1, __pyx_kp_s_Buffer_view_does_not_expose_stri); if (unlikely(!__pyx_tuple__11)) __PYX_ERR(2, 572, __pyx_L1_error)
 ...
 *         return tuple([suboffset for suboffset in self.view.suboffsets[:self.view.ndim]])
 */
  __pyx_tuple__12 = PyTuple_New(1); if (unlikely(!__pyx_tuple__12)) __PYX_ERR(2, 579, __pyx_L1_error)
 ...
 *             else:
 */
  __pyx_slice__15 = PySlice_New(Py_None, Py_None, Py_None); if (unlikely(!__pyx_slice__15)) __PYX_ERR(2, 684, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__16 = PyTuple_Pack(1, __pyx_kp_s_Indirect_dimensions_not_supporte); if (unlikely(!__pyx_tuple__16)) __PYX_ERR(2, 705, __pyx_L1_error)
 ...
 */
  ...
  __pyx_tuple__19 = PyTuple_Pack(3, __pyx_int_184977713, __pyx_int_136983863, __pyx_int_112105877); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(2, 4, __pyx_L1_error)
 ...
 */
  __pyx_tuple__20 = PyTuple_Pack(1, __pyx_kp_s_strided_and_direct_or_indirect); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(2, 287, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__21 = PyTuple_Pack(1, __pyx_kp_s_strided_and_direct); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(2, 288, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__22 = PyTuple_Pack(1, __pyx_kp_s_strided_and_indirect); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(2, 289, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__23 = PyTuple_Pack(1, __pyx_kp_s_contiguous_and_direct); if (unlikely(!__pyx_tuple__23)) __PYX_ERR(2, 292, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__24 = PyTuple_Pack(1, __pyx_kp_s_contiguous_and_indirect); if (unlikely(!__pyx_tuple__24)) __PYX_ERR(2, 293, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initset_util_native(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initset_util_native(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_set_util_native(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_set_util_native(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_set_util_native(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'set_util_native' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_set_util_native(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("set_util_native", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pyclique__set_util_native) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyclique.set_util_native")) {
      if (unlikely(PyDict_SetItemString(modules, "pyclique.set_util_native", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pyclique/set_util_native.pyx":8
 * 
 ...
 */
  ...
  /* "pyclique/set_util_native.pyx":1
 ...
 * cdef indirect = Enum("<strided and indirect>")
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__20, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 287, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__21, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 288, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__22, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 289, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__23, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 292, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__24, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 293, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyclique.set_util_native", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyclique.set_util_native");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
